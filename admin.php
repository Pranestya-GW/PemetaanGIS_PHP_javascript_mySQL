...
<section class="features section-spacing" id="contact">
  <div class="container">
    <h2 class="text-center">KELOLA PETA TITIK WADUK DAN TITIK IRIGASI (EMBUNG)</h2>
    <div class="row">
      <div class="col-md-7">
        ...
        <div class="contact-form">
			...
			<center>
            <!--<button type="submit" class="wow fadeInUp btn btn-simpan submit-btn"  name="lala" value="simpan">SIMPAN</button>-->
		  
		<input type="file" name="file">
		<input type="submit" class="wow fadeInUp btn btn-simpan submit-btn" name="upload" value="Simpan">
			</center>
	</form>
          ...
          <!--contact form end
			...
			<input id="uploadFile" class="wow fadeInUp form-control" placeholder="Upload Gambar..." disabled="disabled" />
